...
describe('Property 11: Consecutive Failure Streak Calculation', () => {
  /**
   * Property: For any sequence of check results, the maximum consecutive failures 
   * SHALL be the length of the longest uninterrupted sequence of failed checks, 
   * and SHALL be at least 0.
   * 
   * **Validates: Requirements 3.5**
   */
  it('should calculate max consecutive failures as longest uninterrupted failure sequence', () => {
    fc.assert(
      fc.property(
        fc.array(fc.boolean()),
        (availabilitySequence) => {
          ...
          // Calculate expected max consecutive failures manually
          let maxStreak = 0;
          let currentStreak = 0;
          ...
          // Property: result must equal the longest uninterrupted failure sequence
          expect(result).toBe(maxStreak);
        }
      ),
      { numRuns: 100 }
    );
  ...
  /**
   * Property: The result is always >= 0
   * 
   * **Validates: Requirements 3.5**
   */
  ...
  /**
   * Property: All successful checks return 0
   */
  ...
  /**
   * Property: All failed checks return total count
   */
  ...
  /**
   * Property: Result never exceeds total number of checks
   */
  ...
  /**
   * Property: Correctly identifies longest streak among multiple streaks
   */
  ...
  /**
   * Property: Single failure results in max consecutive failures = 1
   */
...
describe('Failure Statistics Properties', () => {
  /**
   * Property: Total failures equals count of failed checks
   */
  ...
  /**
   * Property: Failure rate is between 0 and 1
   */
  ...
  /**
   * Property: Failure rate = totalFailures / totalChecks
   */
  ...
  /**
   * Property: Correctly identifies active failure streak
   */
  ...
  /**
   * Property: No active failure streak when ending with success
   */
  ...
  /**
   * Property: Current streak <= max consecutive failures
   */
